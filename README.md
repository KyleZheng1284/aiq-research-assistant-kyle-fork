...
| `config_web_nemo_retriever.yml` | Nemotron 3.5 Lightning; Nemotron 3 Ultra | Web/API with an independently deployed NeMo Retriever knowledge backend plus Tavily. Requires the NRL gateway URL, workspace scope, and optional bearer token. |
